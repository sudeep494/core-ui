...
var CoreTabsComponent = (function () {
    ...
    CoreTabsComponent.decorators = [
        { type: core.Component, args: [{
                    ...
                    encapsulation: core.ViewEncapsulation.None,
                    styles: ["app-tabs { display: block; margin-bottom: 60px; } app-tabs ul.nav-tabs > li > a { background-color: #fff; text-transform: uppercase; color: #606060; font-size: 15px; padding: 10px 12px; border: none; } app-tabs ul.nav-tabs > li > a:hover { background-color: #fff; border-bottom: 6px solid #cdc9c9; } app-tabs ul.nav-tabs > li.active > a, app-tabs ul.nav-tabs > li.active > a:hover { border: none; color: #0cb0dd; background-color: #fff; border-bottom: 6px solid #0cb0dd; } app-tabs ul.nav-tabs { padding-bottom: 1px; border-bottom: 2px solid #cdc9c9; position: relative; } app-tabs ul.nav-tabs li.nav-tab { position: static; } app-tabs ul.nav-tabs li.nav-tab ul.nav-sub-tabs { position: absolute; left: 0; top: 50px; width: 100%; border-bottom: 1px solid #cdc9c9; } app-tabs ul.nav-tabs li.nav-tab ul.nav-sub-tabs li { display: inline-block; margin: 6px 0; padding: 0 10px; border-left: 1px solid #ccc; } app-tabs ul.nav-tabs li.nav-tab ul.nav-sub-tabs li a { background-color: #fff; color: #606060; font-size: 14px; border: none; text-decoration: none; padding: 5px 0; } app-tabs ul.nav-tabs li.nav-tab ul.nav-sub-tabs li a:hover { background-color: #fff; border-bottom: 3px solid #cdc9c9; } app-tabs ul.nav-tabs li.nav-tab ul.nav-sub-tabs li:first-child { border-left: none; } app-tabs ul.nav-tabs li.nav-tab ul.nav-sub-tabs li.active > a, app-tabs ul.nav-tabs li.nav-tab ul.nav-sub-tabs li.active > a:hover { border: none; color: #0cb0dd; background-color: #fff; border-bottom: 3px solid #0cb0dd; } "]
                },] },
    ];
    /** @nocollapse */
